...
void	NinjaTrap::healNoob(std::string const & target)
{
...
void	NinjaTrap::ninjaShoebox(FragTrap trap, std::string const target)
{
	trap.vaulthunter_dot_exe(target);
}

void	NinjaTrap::ninjaShoebox(ScavTrap trap, std::string const target)
{
	trap.challengeNewcomer(target);
}

void	NinjaTrap::ninjaShoebox(NinjaTrap trap, std::string const target)
{
