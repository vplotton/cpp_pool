...
Form::IsNotSignedException::IsNotSignedException() :
	m_msg("Form::IsNotSignedException")
{
}

Form::IsNotSignedException::IsNotSignedException(Form::IsNotSignedException const & src)
{
	*this = src;
}

Form::IsNotSignedException::~IsNotSignedException() throw()
{
}

Form::IsNotSignedException        &Form::IsNotSignedException::operator=(Form::IsNotSignedException const & rhs)
{
	(void)rhs;
	return *this;
}
